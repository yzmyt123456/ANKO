...
if (modal) {
  ...
  console.log('故事折叠块:', !!modal.querySelector('.kb-story'), '故事正文长度:', modal.querySelector('.kb-story-body') ? modal.querySelector('.kb-story-body').textContent.length : 0);
