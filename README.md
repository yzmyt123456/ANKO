...
| GET | `/api/glossary` | 内置 DND 词条词典(属性/技能/法术/装备等) |
| POST | `/api/glossary/linkify` | 文本中的 DND 名词标注为可链接片段 |
| GET | `/api/example/ping` | 示例插件路由 |

## 📖 DND 词条词典与名词跳转

内置 **64 个 DND 专有名词**及其灰机 Wiki 释义页链接
(来源:https://dnd.huijiwiki.com ,玩家手册 2024):

- **属性**:敏捷 / 体质 / 智力 / 感知 / 魅力
- **技能**:运动 / 体操 / 巧手 / 潜行 / 奥秘 / 历史 / 调查 / 自然 / 宗教 / 驯兽 / 洞悉 / 医疗 / 察觉 / 生存 / 欺瞒 / 威吓 / 表演 / 游说
- **法术**:火球术 / 魔法飞弹 / 易容术 / 七彩喷射 / 雷鸣波 / 术法爆发 / 护盾术 / 隐身术 / 飞行术 等 23 个
- **职业 / 规则 / 装备**:术士 / 法师 / 牧师 / 战士 / 盗贼、防御等级 / 生命值 / 熟练加值 / 豁免、长剑 / 匕首 / 短弓 / 奥术法器 等

**自动跳转场景**:
- DND 人物卡详情:法术、熟练、装备、语言等文本字段中的名词自动变为可点击链接
- 六属性格右上角 📖 图标 → 跳转该属性释义(点格子本身仍是掷骰鉴定)
- 安科剧情正文:出现的 DND 名词自动链接(如"施展了火球术"中的火球术)

所有链接点击后**新窗口打开**到对应灰机 Wiki 释义页。
